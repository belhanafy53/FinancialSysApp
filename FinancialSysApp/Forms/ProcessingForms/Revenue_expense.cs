...
{
    public partial class Revenue_expense : DevExpress.XtraEditors.XtraForm
    {
        DateTime DateFR = Convert.ToDateTime(DateTime.Now.ToShortDateString());
        DateTime DateTO = Convert.ToDateTime(DateTime.Now.ToShortDateString()); public Revenue_expense()
        {
            InitializeComponent();
        }
        ...
        private void Revenue_expense_Load(object sender, EventArgs e)
        {
