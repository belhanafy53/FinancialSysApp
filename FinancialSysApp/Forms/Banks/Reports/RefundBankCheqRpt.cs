...
{
    public partial class RefundBankCheqRpt : Form
    {
        ...
        string Vs_DbCredit = "";
        public RefundBankCheqRpt()
        {
            InitializeComponent();
        }

        private void RefundBankCheqRpt_Load(object sender, EventArgs e)
        {
        ...
        private void DTPTo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                this.dtb_RefundCheqBankTableAdapter.FillByDatesRefund(this.bankDateAddedReport.Dtb_RefundCheqBank, Vd_DFrom, Vd_DTo);
        ...
        private void comboBox1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                this.reportViewer1.LocalReport.ReportEmbeddedResource = "FinancialSysApp.Reports.Bank.RefundBankCheq.rdlc";
                this.dtb_RefundCheqBankTableAdapter.FillByDatesBankID(this.bankDateAddedReport.Dtb_RefundCheqBank, Vd_DFrom, Vd_DTo, Vint_Bankid);
