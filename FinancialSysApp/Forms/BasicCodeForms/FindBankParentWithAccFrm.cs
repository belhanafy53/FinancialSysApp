...
{
    public partial class FindBankParentWithAccFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        string SelectTreeTable(int? Parent_ID)
        {
            string Sql = "select distinct b.ID,b.Name,b.Parent_ID from Tbl_Banks b , Tbl_AccountsBank ac WHERE  ac.BankID = b.ID ";
            return Sql;
        }
        ...
        public FindBankParentWithAccFrm()
        {
            InitializeComponent();
        }

        private void FindBankParentWithAccFrm_Load(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(Program.GlbV_Connection))
            {
                ViewTree.fillTreeMulti(treeView1, connection, SelectTreeTable(null), "ID", "Name", "Parent_ID", "");
            }
            Nametxt.Text = "";
            Nametxt.Select();
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            txtBankId.Text = Vint_IdManagement.ToString();
