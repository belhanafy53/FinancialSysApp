...
{
    public partial class ProjectsFrm  : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ProjectsFrm_Load(object sender, EventArgs e)
        {
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            var listItem = FsDb.Tbl_Projects.FirstOrDefault(x => x.ID == Vint_IdItem);
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            if (validationSaveUser != null)
            {
                ...
                {
                    MessageBox.Show("برجاء ادخال المشروع المراد اضافته");
                }
                else
                {
                    ...
                    if (Vint_IdItem == 0)
                    {
                        ...
                        Tbl_Projects Itm = new Tbl_Projects
                        {
                            Name = txtSelected.Text 
                        };
                        FsDb.Tbl_Projects.Add(Itm);
                        FsDb.SaveChanges();
            ...
            {
                MessageBox.Show("ليس لديك صلاحية اضافة  مشروع .. برجاء مراجعة مدير المنظومه");
            }
        }
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            if (validationSaveUser != null)
            {
                ...
                if (result1 == DialogResult.Yes)
                {
                    ...
                    var ListCheckDelete = FsDb.Tbl_Projects.FirstOrDefault(x => x.Parent_ID == Vint_IdItem);
                    if (ListCheckDelete == null)
                    {

                        var listDelete = FsDb.Tbl_Projects.FirstOrDefault(x => x.ID == Vint_IdItem);
                        if (listDelete != null)
                        {
                            FsDb.Tbl_Projects.Remove(listDelete);
                            FsDb.SaveChanges();
                            grbNodeSelected.Text = "";
                            txtSelected.Text = "";
                            //---------------خفظ ااحداث 
                    ...
                    {
                        MessageBox.Show("لايمكن حذف هدا المشروع لاحتوائه على بنود تابعه له قم بحدف تلك البنود اولا");
                    }
            ...
            {
                MessageBox.Show("ليس لديك صلاحية حذف  مشروع .. برجاء مراجعة مدير المنظومه");
            }
        }
        ...
        private void simpleButton4_Click(object sender, EventArgs e)
        {
                ...
                if (Vint_IdItem != null && txtSelected.Text != "")
            {
                ...
                var listupdate = FsDb.Tbl_Projects.FirstOrDefault(x => x.ID == Vint_IdItem);
            ...
            {
                MessageBox.Show("ليس لديك صلاحية تعديل  مشروع .. برجاء مراجعة مدير المنظومه");
            }
        }
