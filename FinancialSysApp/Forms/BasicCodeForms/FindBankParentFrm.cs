...
{
    public partial class FindBankParentFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            string Sql = "Select * From Tbl_Banks  WHERE Parent_ID is null "  ;
            return Sql;
        }
        ...
        public FindBankParentFrm()
        {
            InitializeComponent();
        }

        private void FindBankParentFrm_Load(object sender, EventArgs e)
        {
