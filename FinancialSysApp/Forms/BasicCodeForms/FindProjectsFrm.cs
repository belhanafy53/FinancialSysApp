...
{
    public partial class FindProjectsFrm : Form
    {
        ...
        public FindProjectsFrm()
        {
            InitializeComponent();
        }

        private void FindProjectsFrm_Load(object sender, EventArgs e)
        {
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            txtProjectId.Text = Vint_IdManagement.ToString();
